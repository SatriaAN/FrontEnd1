 ...
 */
const users = [
  { name: "Aufa", age: 19, major: "Informatics" },
  { name: "Ishfani", age: 12, major: "Informatics" },
  { name: "Fai", age: 15, major: "Business" },
  { name: "Agung", age: 29, major: "pajak" },
  { name: "Sabiq", age: 20, major: "Sistem Informasi" },
];
